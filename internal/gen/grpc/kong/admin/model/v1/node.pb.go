...
type Node struct {
	...
	ConfigHash string `protobuf:"bytes,8,opt,name=config_hash,json=configHash,proto3" json:"config_hash,omitempty"` // int32 last_config = 8;
}
...
var file_kong_admin_model_v1_node_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x2e, 0x76, 0x31, 0x22, 0xdc, 0x01, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e,
	...
	0x48, 0x61, 0x73, 0x68, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_kong_admin_model_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_kong_admin_model_v1_node_proto_goTypes = []interface{}{
	(*Node)(nil), // 0: kong.admin.model.v1.Node
}
