...
-- The `constants` variable is copied from the below `kong/plugins/statsd/constants.lua` file.
-- https://github.com/Kong/kong/blob/bcb97611d4bc3c3cd17999afe442c64c8a3f5284/kong/plugins/statsd/constants.lua
local constants = {
